...
void default_constants() {
  // P, I, D, and Start I
  chassis.pid_drive_constants_forward_set(15.6, 0.0, 124.75);
  chassis.pid_drive_constants_backward_set(19.0, 0.0, 100.0);
  chassis.pid_heading_constants_set(11.0, 0.0, 21.0);        // Holds the robot straight while going forward without odom
  chassis.pid_turn_constants_set(3.40, 0.05, 20.0, 15.0);     // Turn in place constants
